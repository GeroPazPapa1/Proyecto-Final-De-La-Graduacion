...
const Review = () => {
  ...
  return (
    <div>
      ...
      {idUser && <form onSubmit={handleSubmit}>
      {[...Array(5)].map((star, i) => {
      ...
      <div>
        ...
        <textarea name="review" value={data.review} onChange={handleChange} placeholder='Review:' cols="5" rows="3"></textarea>
          ...
          <div key={index }>
            {editingReview === review.id ? (
              <form onSubmit={() => handleUpdateSubmit()}>
                ...
                <input type="text" name="title" value={newData.title} onChange={(event) => handleUpdateChange(event, review.id)} placeholder={review.title}/>
                <input type="text" name="review" value={newData.review} onChange={(event) => handleUpdateChange(event, review.id)} placeholder={review.review}/>
