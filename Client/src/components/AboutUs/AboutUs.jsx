        ...
        <div className={styles.container}>
            ...
            <div className={styles.contPhotons}>
                <div className={styles.cards}>
                    <div>
                        <Link to={"http://www.linkedin.com/in/gerónimo-nicolás-paz-papa"} target="_blank">
                    ...
                    <div className={styles.containerCount}>
                        ...
                        <img className={styles.countryI} src={Argentina} alt="Argentina..." />
                    </div>
                    <div className={styles.fullS}>Full Stack Developer</div>
                    <div className={styles.redes}>
                        <Link to={"mailto:Geronimonicolaspazpapa@gmail.com"} target="_blank">
                ...
                <div className={styles.cards}>
                    <div>
                        <Link to={"https://www.linkedin.com/in/daniel-felipe-botache-zuluaga-0180391a4/"} target="_blank">
                ...
                <div className={styles.cards}>
                    <div>
                        <Link to={"https://www.linkedin.com/in/jos%C3%A9-emanuel-rosas-31b1a8190/"} target="_blank">
