...
export default function DashBoardEmail() {
  ...
  const selectedEmails = Object.keys(emailSelection).filter(
    (key) => emailSelection[key]
  );
  ...
  return (
    <div>
      ...
      <div className={styles.filtersEdit}>
        <Filters />
        <button
          className={aux < 2 ? styles.deleteDisabled : styles.delete}
          onClick={handleCheckboxActionDelete}
          disabled={aux < 2}
        >
          <img
        ...
        <button
          className={aux < 2 ? styles.editDisabled : styles.edit}
          onClick={handleCheckboxActionEdit}
          disabled={aux < 2}
        >
          <img
            className={styles.img}
