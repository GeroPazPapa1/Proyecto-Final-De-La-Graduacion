...
import ICONDOWN from "../../Home/Filters/Icons/ICONDOWN.png";
import ICONUP from "../../Home/Filters/Icons/ICONUP.png";
...
// return(
//     <p>Color, Model, Price, Location, State</p>
// )
    return (<div className={styles.container}>
        <div className={styles.filters}>
        <h3>Color</h3>
        {
                    colorQuerys.slice(0, showAllColors ? undefined : 8)?.map((color) => (
                        <label key={color}>
                            <input
    ...
    //             }
    //         </div>
    //         {brandQuerys.length > 1 && (
    //             <button onClick={toggleShowAllBrands} className={styles.filters}>
    //                 {showAllBrands ? (
    //                     <>
    ...
    //             <h3>Color</h3>
    //             {
    //                 colorQuerys.slice(0, showAllColors ? undefined : 1)?.map((color) => (
    //                     <label key={color}>
    //                         <input
    //                             type="checkbox"
    //                             value={color}
    ...
    //             }
    //         </div>
    //         {colorQuerys.length > 1 && (
    //             <button onClick={toggleShowAllColors} className={styles.filters}>
    //                 {showAllColors ? (
    //                     <>
    //                         Show less <img className={styles.iconF} src={ICONUP} alt="IconU..." />
    //                     </>
